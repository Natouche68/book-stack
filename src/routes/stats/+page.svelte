...
<div class="mx-4 mt-6 flex flex-row items-end gap-4">
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Lu</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Ma</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Me</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Je</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Ve</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Sa</div>
	</div>
	<div class="w-full">
		...
		></div>
		<div class="italic text-center text-green-900 dark:text-green-100">Di</div>
	</div>
</div>
<div class="mb-6 text-center text-sm text-green-900 dark:text-green-100">
	Moyenne de pages lues par jour
</div>

<div class="flex flex-row flex-wrap">
	<div class="w-1/2 my-4">
		<div class="italic text-green-900 dark:text-green-100 text-center">
			Pages lues
		</div>
	...
	<div class="w-1/2 my-4">
		...
		<div class="text-4xl font-serif font-bold text-center">
			...
			<span
				class="text-base italic text-green-900 dark:text-green-100 text-center"
				>pages</span
			>
		</div>
	</div>
